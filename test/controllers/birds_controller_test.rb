...
class BirdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post birds_url, params: { bird: { blurb: @bird.blurb, name: @bird.name, url: @bird.url } }, as: :json
    end
  ...
  test "should update bird" do
    patch bird_url(@bird), params: { bird: { blurb: @bird.blurb, name: @bird.name, url: @bird.url } }, as: :json
    assert_response 200
  end
